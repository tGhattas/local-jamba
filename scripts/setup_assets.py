#!/usr/bin/env python3
"""Download the default GGUF model and PDF assets for the Jamba CLI."""
...
DEFAULT_DOC_PATH = DOC_DIR / "oecd-digital-learning.pdf"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pdf-path", default=str(DEFAULT_DOC_PATH), help="Where to store the PDF.")
    parser.add_argument(
        "--model-repo",
    ...
    parser.add_argument(
        ...
        help="Where to store the GGUF model locally.",
    )
    parser.add_argument(
        "--force",
        action="store_true",
